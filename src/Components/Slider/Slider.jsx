  ...
  return (
    <>
      <div className="relative pb-4">
        ...
        <div className="absolute flex bottom-12 left-[45%]">
        ...
        <div>
          ...
          <button className="absolute top-[50%] left-0 bg-white rounded-full p-2 hover:bg-green-300" onClick={() => dispatch(prevSlide(slideIndex - 1))}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
